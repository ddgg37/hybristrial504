 ...
 *  
 */
package de.hybris.platform.cuppytrailwebservices.jalo;
...
import de.hybris.platform.cuppytrailwebservices.constants.CuppytrailwebservicesConstants;



/**
 * This is the extension manager of the Cuppytrailwebservices extension.
 */
public class CuppytrailwebservicesManager extends GeneratedCuppytrailwebservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CuppytrailwebservicesManager.class.getName());
	 ...
	 */
	public static CuppytrailwebservicesManager getInstance()
	{
		return (CuppytrailwebservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CuppytrailwebservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CuppytrailwebservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CuppytrailwebservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CuppytrailwebservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CuppytrailwebservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
